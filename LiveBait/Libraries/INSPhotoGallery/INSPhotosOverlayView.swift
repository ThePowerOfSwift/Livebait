...
open class INSPhotosOverlayView: UIView , INSPhotosOverlayViewable {
    ...
    @objc private func actionButtonTapped(_ sender: UIBarButtonItem) {
        if let currentPhoto = currentPhoto {
            photosViewController?.handleSetAsProfilePictureTapped()
...
//            });
    ...
    private func setupNavigationBar() {
        ...
        rightBarButtonItem = UIBarButtonItem(title: "Set as profile photo", style: .plain, target: self, action: #selector(INSPhotosOverlayView.actionButtonTapped(_:)))
