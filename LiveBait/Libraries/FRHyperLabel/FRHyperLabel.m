...
static CGFloat highLightAnimationTime = 0.1;
...
+ (void)initialize {
	if (self == [FRHyperLabel class]) {
        ...
        //UIColor(red: 49.0/255.0, green: 170.0/255.0, blue: 224.0/255.0, alpha: 1)
		FRHyperLabelLinkColorDefault = [UIColor colorWithRed:49.0/255.0 green:170.0/255.0 blue:224.0/255.0 alpha:1];
		FRHyperLabelLinkColorHighlight = [UIColor colorWithRed:49.0/255.0 green:170.0/255.0 blue:224.0/255.0 alpha:1];
	}
}
